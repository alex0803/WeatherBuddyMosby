...
import com.example.awang.weatherbuddymosby.weathershow.fragment3.WeatherShow3Adapter;
import com.example.awang.weatherbuddymosby.weathershow.fragment3.WeatherShow3Presenter;
 ...
 */
public class WeatherShow5Fragment extends MvpLceFragment <SwipeRefreshLayout, List<WeatherInfoBean>, WeatherShowView, WeatherShow5Presenter>
                                    implements WeatherShowView, SwipeRefreshLayout.OnRefreshListener{


    @BindView(R.id.recyclerView_weather_show)
    RecyclerView recyclerView;
    private WeatherShow5Adapter adapter;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new WeatherShow5Adapter(getContext());
    ...
    @Override
    public WeatherShow5Presenter createPresenter() {
        return new WeatherShow5Presenter();
